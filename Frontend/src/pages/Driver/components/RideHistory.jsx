      ...
      <div className="bg-[#0d1020] border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
        {historyList.length === 0 ? (
          <div className="p-12 text-center text-slate-400">
            ...
            <p className="text-sm font-bold text-white mb-1">No Past Commutes Found</p>
            <p className="text-xs text-slate-500">Create and publish your first ride pool to view trip logs here.</p>
          </div>
        ) : (
