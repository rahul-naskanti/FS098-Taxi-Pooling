    ...
    <>
      ...
      <header className="h-20 bg-[#0a0d17] border-b border-slate-855 px-6 sm:px-8 flex items-center justify-between z-10 shrink-0">
        <div className="hidden sm:block">
          <h2 className="text-base font-bold text-white font-display">Manage Pools</h2>
          <p className="text-[11px] text-slate-500">Earnings & Commuter Matching Console</p>
        </div>
